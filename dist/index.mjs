...
import React, { useEffect as useEffect3, useMemo as useMemo3, useRef as useRef2, useState as useState3 } from "react";

// src/hooks/usePhoneInput.ts
import { useCallback, useEffect as useEffect2, useLayoutEffect, useMemo as useMemo2, useRef, useState as useState2 } from "react";
...
var usePhoneInput = (options) => {
  ...
  const [internalDigits, setInternalDigits] = useState2(() => sanitizeDigits(defaultValue));
  useEffect2(() => {
  ...
  const selectedCountry = useMemo2(() => {
...
var PhoneInput = React.forwardRef((props, forwardedRef) => {
  const {
    value,
    defaultValue,
    onValueChange,
  ...
  const countryList = useMemo3(() => (customCountries ?? countries).slice().sort((a, b) => a.name.localeCompare(b.name)), [customCountries]);
  const {
    state,
    inputProps,
  ...
  const filteredCountries = useMemo3(() => {
  ...
  const inputId = useMemo3(() => id ?? `phone-input-${Math.random().toString(36).slice(2, 8)}`, [id]);
  ...
  return /* @__PURE__ */ jsxs("div", { className, ref: containerRef, style: defaultStyles.container, children: [
    label && /* @__PURE__ */ jsx("label", { htmlFor: inputId, style: { fontSize: 12, fontWeight: 600 }, children: label }),
    /* @__PURE__ */ jsxs("div", { style: defaultStyles.wrapper, onKeyDown: handleWrapperKeyDown, children: [
      /* @__PURE__ */ jsxs(
        "button",
        {
          type: "button",
          ...
          children: [
            showFlag && /* @__PURE__ */ jsx("span", { style: { marginRight: 4 }, children: toFlagEmoji(selectedCountry.iso2) }),
      ...
      isOpen && /* @__PURE__ */ jsxs("div", { className: dropdownClassName, style: dropdownStyle, role: "listbox", "aria-label": "Country list", children: [
        /* @__PURE__ */ jsx(
          "input",
          {
            ref: searchInputRef,
        ...
        filteredCountries.map((candidate) => /* @__PURE__ */ jsxs(
          "div",
          {
            role: "option",
            ...
            children: [
              ...
              /* @__PURE__ */ jsx("span", { children: candidate.dialCode })
            ]
          },
          candidate.iso2
        ))
    ...
    helperText && /* @__PURE__ */ jsx("p", { id: helperId, style: defaultStyles.helper, children: helperText })
  ] });
});
